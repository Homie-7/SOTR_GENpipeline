...
| S9-SAL-R | `prompts/S9-SAL-R.txt` v3, NBP reference-led | `@loc_SOTR_salon_R_s9_v1` | **confirmed 2026-09-22** — ready to run, ref: approved room master |
...
| S9-STU-L | `prompts/S9-STU-L.txt` v1, NBP reference-led, new composition | `@loc_SOTR_studio_L_s9_v1` | **ready to run 2026-09-23** — room master approved under the night-light prompt (v3), ref: `@loc_SOTR_studio_room_s9_v1` |
